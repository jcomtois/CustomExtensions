...
namespace CustomExtensions.ForIEnumerable
{
    public static partial class ExtendIEnumerable
    {
        ...
        public static TResult? NullableMin<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, TResult> selector) where TResult : struct, IComparable<TResult>
        {
            Validate.Begin()
        ...
        private static TResult? NullableMinImplementation<TSource, TResult>(IEnumerable<TSource> source, Func<TSource, TResult> selector) where TResult : struct, IComparable<TResult>
        {

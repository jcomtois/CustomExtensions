...
namespace UnitTests.ForStringsTests
{
    public partial class StringTests
    {
        ...
        {
            private static readonly string LatinString = new string(Enumerable.Range(0, 256).Select(i => Convert.ToChar(Convert.ToByte(i))).ToArray());
